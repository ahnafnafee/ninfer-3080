 ...
 *
 * This installation's eager catalog of 441 skills adds about 160K characters
 * to the first request. Expose two small tools to search and load skills only
 * when needed within the 64K model window:
 *
 ...
 *    without an up-front catalog dump.
