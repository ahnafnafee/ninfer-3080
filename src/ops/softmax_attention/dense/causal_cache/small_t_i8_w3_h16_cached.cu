// Width-3 H16 cached instantiation of the INT8-family small-T partial launch; one unit per
...
template void launch_small_t_i8<CausalD256H16Kv2, 3, CausalCachedInput>(bool, bool, const Tensor&, CausalCachedInput, const Tensor&, float,
