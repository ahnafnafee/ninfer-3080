// Width-5 H24 cached instantiation of the INT8-family small-T partial launch; one unit per
...
template void launch_small_t_i8<CausalD256H24Kv4, 5, CausalCachedInput>(bool, bool, const Tensor&, CausalCachedInput, const Tensor&, float,
