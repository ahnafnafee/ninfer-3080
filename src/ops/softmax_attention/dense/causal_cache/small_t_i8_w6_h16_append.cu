// Width-6 H16 append instantiation of the INT8-family small-T partial launch; one unit per
...
template void launch_small_t_i8<CausalD256H16Kv2, 6, CausalAppendInput>(bool, bool, const Tensor&, CausalAppendInput, const Tensor&, float,
