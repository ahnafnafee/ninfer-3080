...
(`ef976023`) плюс два коммита этой ветки. Один запрос за раз, жадное декодирование
(`temperature 0`), чтобы профили спекуляции сравнивались на одинаковом тексте.
...
- Умолчания сэмплинга движка: в режиме рассуждения temp 1,0, top_k 20, top_p 0,95; без
  рассуждения 0,7 / 20 / 0,80 и presence_penalty 1,5. В замерах temp 0.
