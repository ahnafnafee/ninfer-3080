...
- С графиком по глубине эти цифры не сравнить: там промпт от 9345 токенов и
  прозаический ответ по тексту, DFlash2 принимает около 20% черновиков. Выше графика
  здесь поднимается только короткий код.
