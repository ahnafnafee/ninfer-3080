...
// The ternary integer-activation routes through one policy: the small-T kernel (1..128 tokens, in
// launches of one, two and four column tiles) and above it the prefill GEMM, which pads T to a
// multiple of 128 inside.
int t2_a8_conformance() {
    int failures = 0;

    constexpr std::array kWidths{
        a8(1),   a8(2),   a8(3),   a8(4),   a8(5),   a8(7),   a8(8),   a8(9),    a8(12),  a8(15),
        a8(16),  a8(17),  a8(24),  a8(32),  a8(33),  a8(40),  a8(63),  a8(64),   a8(65),  a8(95),
        a8(100), a8(127), a8(128), a8(129), a8(200), a8(256), a8(385), a8(1007), a8(1024)};
