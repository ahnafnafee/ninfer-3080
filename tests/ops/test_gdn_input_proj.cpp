...
int run_q4_q5() {
    ...
    int failures = 0;
    // Every route boundary and its neighbours in both route tables: on sm_8x the small-T MMA takes
    // 1..32 and the 64- and 128-wide grouped tiles the rest; a native sm_120 build hands 1..12 to
    // the per-side small-column kernels, 13..32 to the 32x32 tile, 33..64 to the 32x64 tile and 65
